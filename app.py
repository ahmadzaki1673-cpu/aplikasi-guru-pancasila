...
URL_SHEET = "https://docs.google.com/spreadsheets/d/XXXXXXXXXX/edit#gid=0"
    ...
    with t1:
        ...
        with st.form("f_jurnal"):
            ...
            if st.form_submit_button("Simpan ke Google Sheets"):
                ...
                st.success("Data Berhasil Tersimpan Selamanya!")
...
# --- 2. PENILAIAN SISWA ---
    ...
    with st.form("f_nilai"):
        ...
        for nama in DAFTAR_SISWA[kls_n]:
            ...
            data_nilai.append({"Nama": nama, "Kelas": kls_n, "Jenis": j_d, "Materi": mat, "Nilai": skor})
